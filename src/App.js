    ...
    <>
      ...
      <div className="App">
        <header className="App-header">
          <img
            className="logo-formik"
            src="https://user-images.githubusercontent.com/4060187/61057426-4e5a4600-a3c3-11e9-9114-630743e05814.png"
            alt="logo"
          />
          <div className="button-container">
            <div className="margin-right-20">
              <Button variant="secondary" size="lg" onClick={() => openForm(BASIC_FORM)}>
                Basic Form
              </Button>
            </div>
            <div className="margin-right-20">
              <Button variant="secondary" size="lg" onClick={() => openForm(BASIC_FORM_WITH_VALIDATIONS)}>
                Basic Form with Validations
              </Button>
            </div>
            <div className="margin-right-20">
              <Button variant="secondary" size="lg" onClick={() => openForm(CUSTOM_FORM)}>
                Custom Form
              </Button>
            </div>
          </div>
