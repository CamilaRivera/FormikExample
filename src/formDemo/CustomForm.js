        ...
        <div className="form-container">
          <div className="flex-1 margin-right-20 padding-top-10">
            <div className="margin-top-20">
              <label htmlFor="multiselect">MultiSelect <span className="red">*</span></label>
              <MultiSelectInput
                id="multiselect"
                label="multiselect"
                name="multiselect"
            ...
            <div className="margin-top-20">
              <label htmlFor="dateInput">Date <span className="red">*</span></label>
            ...
            <div className="margin-top-20">
              <label htmlFor="firstName">Formik Text Input <span className="red">*</span></label>
            ...
            <div className="margin-top-20">
              <label htmlFor="textInput">Custom Fast Field Text Input <span className="red">*</span></label>
